<x-app-layout :meta-title="$post->meta_title ?: $post->title" :meta-desctiption="$post->meta_description">
    <!-- Post Section -->
            ...
            <div class="w-1/2">
                @if ($prev)
                    <a href="{{ route('view', $prev) }}"
                        ...
                        <p class="pt-2">{{ \Illuminate\Support\Str::words($prev->title) }}</p>
                    </a>
                @endif
            </div>
            <div class="w-1/2">
                <a href="{{ route('view', $post->slug) }}"
