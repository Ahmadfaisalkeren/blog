...
<head>
    ...
    <title>{{ $metaTitle ?: 'Ahmad Faisal Blog' }}</title>
    <meta name="author" content="Ahmad Faisal Blog">
...
<body class="bg-gray-50 font-family-karla">
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        ...
        <div :class="open ? 'block' : 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div
                ...
                @endforeach --}}
                <a href="{{ route('about-us') }}" class="hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2">About Me</a>
            </div>
        </div>
    </nav>
    ...
    <footer class="w-full border-t bg-white pb-12">
        <div class="w-full container mx-auto flex flex-col items-center">
            <div class="uppercase py-6">&copy; Ahmad Faisal 2023</div>
        </div>
    </footer>
